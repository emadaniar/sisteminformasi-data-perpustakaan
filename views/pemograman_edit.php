<?php
$no=$_GET['no'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_pemograman WHERE no ='$no'") or die ("SQL Edit error");
...
if($_POST){
    ...
    $jumlah=$_POST['jumlah'];
    //buat sql
    $sql="UPDATE tbl_pemograman SET nama_buku='$nama_buku',nama_pengarang='$nama_pengarang',tahun_terbit='$tahun_terbit',jumlah='$jumlah' WHERE no ='$no'"; 
