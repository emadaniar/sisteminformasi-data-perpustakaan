<?php
$no=$_GET['no'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_sosial WHERE no ='$no'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-warning">
                ...
                <div class="panel-footer">
                    <a href="?page=sosial&actions=tampil" class="btn btn-danger btn-sm">
...
if($_POST){
    ...
    $jumlah=$_POST['jumlah'];
    //buat sql
    $sql="UPDATE tbl_sosial SET nama_buku='$nama_buku',nama_pengarang='$nama_pengarang',tahun_terbit='$tahun_terbit',jumlah='$jumlah' WHERE no ='$no'"; 
