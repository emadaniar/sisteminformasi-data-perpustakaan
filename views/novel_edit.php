<?php
$no=$_GET['no'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_novel WHERE no ='$no'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-warning">
                ...
                <div class="panel-footer">
                    <a href="?page=novel&actions=tampil" class="btn btn-danger btn-sm">
...
if($_POST){
    ...
    $jumlah=$_POST['jumlah'];
    //buat sql
    $sql="UPDATE tbl_novel SET nama_buku='$nama_buku',nama_pengarang='$nama_pengarang',tahun_terbit='$tahun_terbit',jumlah='$jumlah' WHERE no ='$no'"; 
