        ...
        <div class="col-xs-12">
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Tambah Data Struktur</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="nik" class="form-control" id="inputEmail3" placeholder="NIK/NIP">
                            </div>
                        </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success">
                                    <span class="fa fa-edit"></span> Tambah Data Struktur</button>
                            </div>
                        </div>
                    </form>
...
if($_POST){
 ...
 $nik=$_POST['nik'];
    ...
    //buat sql
    $sql="INSERT INTO tbl_struktur VALUES ('','$nik','$nama','$tanggal_masuk','$jabatan')";
