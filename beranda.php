    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-warning">
                <strong>Selamat Datang di Sistem Informasi Perpustakaan SMK Negeri 2 Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Struktur Persputakaan SMK Negeri 2 Kisaran</h3>
                </div>
        ...
        <div class="col-sm-3 col-xs-12">
            ...
            <div class="alert alert-warning">
                <strong>Welcome <?=$_SESSION['ema']?></strong>
            </div>
